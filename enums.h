...
enum itemAttrTypes : uint32_t {
	...
	ITEM_ATTRIBUTE_CRITICALHITCHANCE = 1 << 23,
	ITEM_ATTRIBUTE_DODGECHANCE = 1 << 24,
	ITEM_ATTRIBUTE_LIFEABSORB = 1 << 25,
	ITEM_ATTRIBUTE_MANAABSORB = 1 << 26,
	ITEM_ATTRIBUTE_LIFELEECH = 1 << 27,
	ITEM_ATTRIBUTE_MANALEECH = 1 << 28,
	ITEM_ATTRIBUTE_REFLECT = 1 << 29,
	ITEM_ATTRIBUTE_MOMENTUM = 1 << 30,
	ITEM_ATTRIBUTE_CRITICALDAMAGE = 1 << 31
};
