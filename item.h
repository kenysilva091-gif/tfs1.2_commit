	...
	public:
		...
		int32_t getCriticalHitChance() const {
			if (hasAttribute(ITEM_ATTRIBUTE_CRITICALHITCHANCE)) {
				return getIntAttr(ITEM_ATTRIBUTE_CRITICALHITCHANCE);
			}
