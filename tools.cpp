...
itemAttrTypes stringToItemAttribute(const std::string& str)
{
	...
	} else if (str == "dodgechance") {
		return ITEM_ATTRIBUTE_DODGECHANCE;
	} else if (str == "lifeabsorb") {
		return ITEM_ATTRIBUTE_LIFEABSORB;
	} else if (str == "manaabsorb") {
		return ITEM_ATTRIBUTE_MANAABSORB;
